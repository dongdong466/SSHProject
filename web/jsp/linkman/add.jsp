...
<html>
<head>
<TITLE><s:property value="#linkMan==null?'添加':'修改'"/>客户联系人</TITLE>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property value="#linkMan==null?'添加':'修改'"/>客户联系人</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								...
								<input type="text" name="cust_name" style="WIDTH: 180px" id="cust_name" value="<s:property value="#linkMan.customer.cust_name"/>"/>
