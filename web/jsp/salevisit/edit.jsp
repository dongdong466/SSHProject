...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/SaleVisitAction_update"
		method=post>
		<!-- 隐藏域回显当前编辑的拜访记录id -->
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								...
								<td>
									...
									<input type="text" name="cust_name" style="WIDTH: 180px" id="cust_name" value="<s:property value="#saleVisit.customer.cust_name"/>"/>
